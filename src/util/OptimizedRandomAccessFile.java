...
public class OptimizedRandomAccessFile {
     ...
     * This method behaves similar to the method of
     * <code>BufferedReader</code>.
     *
     ...
     * bytes. This method behaves similar to the method of
     * <code>BufferedReader</code>.
     *
     * @param b the buffer into which the data is read.
     * @return the total number of bytes read into the buffer, or
    ...
    /**
     * Closes this random access file stream and releases any system main.resources
