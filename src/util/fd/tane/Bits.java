...
/**
 * This class provides basic methods for clearing, setting and testing
 * bits on an integer variable. The underlying code has been adapted from
 * the book "Java ist eine Insel, C. Ulleboom".
 *
 * @author Tobias
 */
public class Bits {
